...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        const url = `${global.APIs.vreden.url}/api/v1/maker/ephoto/glowingtext?text=${encodeURIComponent(text)}`;
...
handler.help = ['glowingtext <texto>'];
handler.tags = ['maker'];
handler.command = ['glowingtext'];
handler.group = true;
