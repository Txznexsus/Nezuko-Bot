...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        const url = `${global.APIs.vreden.url}/api/v1/maker/ephoto/advancedglow?text=${encodeURIComponent(text)}`;
...
handler.help = ['advancedglow <texto>'];
handler.tags = ['maker'];
handler.command = ['advancedglow'];
handler.group = true;
