...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        const url = `${global.APIs.vreden.url}/api/v1/maker/ephoto/summerbeach?text=${encodeURIComponent(text)}`;
...
handler.help = ['summerbeach <texto>'];
handler.tags = ['maker'];
handler.command = ['summerbeach'];
handler.group = true;
