...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        const url = `${global.APIs.vreden.url}/api/v1/maker/ephoto/deletingtext?text=${encodeURIComponent(text)}`;
...
handler.help = ['deletingtext <texto>'];
handler.tags = ['maker'];
handler.command = ['deletingtext'];
handler.group = true;
