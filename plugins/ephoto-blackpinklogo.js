...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        const url = `${global.APIs.vreden.url}/api/v1/maker/ephoto/blackpinklogo?text=${encodeURIComponent(text)}`;
...
handler.help = ['blackpinklogo <texto>'];
handler.tags = ['maker'];
handler.command = ['blackpinklogo'];
handler.group = true;
