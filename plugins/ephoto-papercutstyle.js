...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        const url = `${global.APIs.vreden.url}/api/v1/maker/ephoto/papercutstyle?text=${encodeURIComponent(text)}`;
...
handler.help = ['papercutstyle <texto>'];
handler.tags = ['maker'];
handler.command = ['papercutstyle'];
handler.group = true;
