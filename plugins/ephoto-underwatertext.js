...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        const url = `${global.APIs.vreden.url}/api/v1/maker/ephoto/underwatertext?text=${encodeURIComponent(text)}`;
...
handler.help = ['underwatertext <texto>'];
handler.tags = ['maker'];
handler.command = ['underwatertext'];
handler.group = true;
