...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        const url = `${global.APIs.vreden.url}/api/v1/maker/ephoto/gradienttext?text=${encodeURIComponent(text)}`;
...
handler.help = ['gradienttext <texto>'];
handler.tags = ['maker'];
handler.command = ['gradienttext'];
handler.group = true;
