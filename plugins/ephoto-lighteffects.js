...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        const url = `${global.APIs.vreden.url}/api/v1/maker/ephoto/lighteffects?text=${encodeURIComponent(text)}`;
...
handler.help = ['lighteffects <texto>'];
handler.tags = ['maker'];
handler.command = ['lighteffects'];
handler.group = true;
