...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        const url = `${global.APIs.vreden.url}/api/v1/maker/ephoto/galaxywallpaper?text=${encodeURIComponent(text)}`;
...
handler.help = ['galaxywallpaper <texto>'];
handler.tags = ['maker'];
handler.command = ['galaxywallpaper'];
handler.group = true;
