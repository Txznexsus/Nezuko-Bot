...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        const url = `${global.APIs.vreden.url}/api/v1/maker/ephoto/watercolortext?text=${encodeURIComponent(text)}`;
...
handler.help = ['watercolortext <texto>'];
handler.tags = ['maker'];
handler.command = ['watercolortext'];
handler.group = true;
