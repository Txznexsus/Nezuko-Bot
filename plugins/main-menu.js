...
let handler = async (m, { conn, usedPrefix, __dirname, participants }) => {
  try {
    ...
    let tags = {
      'info': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ɪɴғᴏ` 🍂 ᦡᦡ',
      'main': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ᴍᴀɪɴ` 🍓 ᦡᦡ',
      'fun': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ғᴜɴ` 🎭 ᦡᦡ',
      'rpg': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ʀᴘɢ` 🍂 ᦡᦡ',
      'anime': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ᴀɴɪᴍᴇ` 🌸',
      'search': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ sᴇᴀʀᴄʜ` 🧬 ᦡᦡ',
      'download': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ᴅᴏᴡɴʟᴏᴀᴅ` 🎧 ᦡᦡ',
      'gacha': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ɢᴀᴄʜᴀ` 🌀 ᦡᦡ',
      'rg': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ᴘᴇʀғɪʟ` 🍃 ᦡᦡ',
      'game': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ɢᴀᴍᴇ` 🎮 ᦡᦡ',
      'group': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ɢʀᴜᴘᴏs` 🏮 ᦡᦡ',
      'nable': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ɴᴀʙʟᴇ` ⚙️ ᦡᦡ',
      'ia': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ɪᴀ` ☁️ ᦡᦡ',
      'stalk': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ stalk` 🌹',
      'maker': '𓂂𓏸 𐅹੭੭ 𐂂 `mᥱᥒᥙ ᥣ᥆g᥆𝗍і⍴᥆s` 🌿 ᦡᦡ',
      'tools': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ᴛᴏᴏʟs` 🧩 ᦡᦡ',
      'sticker': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ sᴛɪᴄᴋᴇʀs` ✨ ᦡᦡ',
      'owner': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ᴏᴡɴᴇʀ` 💙 ᦡᦡ',
      'socket': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ᴊᴀᴅɪ-ʙᴏᴛ` 🍰 ᦡᦡ',
      'nsfw': '𓂂𓏸 𐅹੭੭ 𐂂 `ᴍᴇɴᴜ ɴsғᴡ` 🍑 ᦡᦡ',
    }
