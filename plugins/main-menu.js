...
let handler = async (m, { conn, usedPrefix, __dirname, participants }) => {
  try {
    ...
    let tags = {
      ...
      'fun': '❐*̥₊  `ᴍᴇɴᴜ ғᴜɴ` 🎭࿆⸼',
      'rpg': '❐*̥₊  `ᴍᴇɴᴜ ʀᴘɢ` 🍂࿆⸼',
      'anime': '❐*̥₊  `ᴍᴇɴᴜ ᴀɴɪᴍᴇ` 🌸࿆⸼',
      'search': '❐*̥₊  `ᴍᴇɴᴜ sᴇᴀʀᴄʜ` 🧬࿆⸼',
      'download': '❐*̥₊  `ᴍᴇɴᴜ ᴅᴏᴡɴʟᴏᴀᴅ` 🎧࿆⸼',
      'gacha': '❐*̥₊  `ᴍᴇɴᴜ ɢᴀᴄʜᴀ` 🌀࿆⸼',
      'rg': '❐*̥₊  `ᴍᴇɴᴜ ᴘᴇʀғɪʟ` 🍃࿆⸼',
      'game': '❐*̥₊  `ᴍᴇɴᴜ ɢᴀᴍᴇ` 🎮࿆⸼',
      'group': '❐*̥₊  `ᴍᴇɴᴜ ɢʀᴜᴘᴏs` 🏮࿆⸼',
      'nable': '❐*̥₊  `ᴍᴇɴᴜ ɴᴀʙʟᴇ` ⚙️࿆⸼',
      'ia': '❐*̥₊  `ᴍᴇɴᴜ ɪᴀ` ☁️࿆⸼',
      'stalk': '❐*̥₊  `ᴍᴇɴᴜ stalk` 🌹࿆⸼',
      'maker': '❐*̥₊  `mᥱᥒᥙ ᥣ᥆g᥆𝗍і⍴᥆s` 🌿࿆⸼',
      'tools': '❐*̥₊  `ᴍᴇɴᴜ ᴛᴏᴏʟs` 🧩࿆⸼',
      'sticker': '❐*̥₊  `ᴍᴇɴᴜ sᴛɪᴄᴋᴇʀs` ✨࿆⸼',
      'owner': '❐*̥₊  `ᴍᴇɴᴜ ᴏᴡɴᴇʀ` 💙࿆⸼',
      'socket': '❐*̥₊  `ᴍᴇɴᴜ ᴊᴀᴅɪ-ʙᴏᴛ` 🍰࿆⸼',
      'nsfw': '❐*̥₊  `ᴍᴇɴᴜ ɴsғᴡ` 🍑࿆⸼',
    }
