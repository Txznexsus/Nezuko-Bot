...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        const url = `${global.APIs.vreden.url}/api/v1/maker/ephoto/effectclouds?text=${encodeURIComponent(text)}`;
...
handler.help = ['effectclouds <texto>'];
handler.tags = ['maker'];
handler.command = ['effectclouds'];
handler.group = true;
